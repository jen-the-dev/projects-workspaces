...
- [multi-platform-ecommerce-web-app](https://github.com/jen-the-dev/multi-platform-ecommerce-web-app) — Next.js + Express + Stripe full-stack with CI and tests
...
- [ict-support-service-desk-automation-portal](https://github.com/jen-the-dev/ict-support-service-desk-automation-portal) — Service desk triage and runbook automation
