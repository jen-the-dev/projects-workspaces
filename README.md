...
This portfolio is curated for **ANZSCO 261312 (Developer Programmer)** presentation to recruiters and migration assessors.

## Profile summary
- End-to-end software delivery across backend APIs, full-stack systems, realtime data workflows, and CI/CD automation.
...
- NZ-focused category set: `workspaces/nz-aewv.code-workspace`
- All local repos: `workspaces/all-projects.code-workspace`
